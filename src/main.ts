...
import { faPlay, faPause, faCopy, faPen, faTrashCan, faHeart as fasHeart, faBookmark as fasBookmark, faRetweet, faShareFromSquare, faComment as fasComment, faCircleXmark, faPaperclip, faLink, faSliders, faCircleCheck, faTriangleExclamation, faCircleInfo, faXmark } from '@fortawesome/free-solid-svg-icons';
...
library.add(faPlay, faPause, faCopy, faPen, faTrashCan, fasHeart, fasBookmark, faRetweet, faShareFromSquare, fasComment, faCircleXmark, faPaperclip, faLink, faSliders, faCircleCheck, faTriangleExclamation, faCircleInfo, faXmark);
